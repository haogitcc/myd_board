...
//	if(ip_settings.netmask)
//	{
//		fprintf(cgiOut, "netmask: ");
//		cgiHtmlEscape(&ip_settings.netmask); 
//	}
//	else
//	{
//		fprintf(cgiOut, "not get netmask ");
//	}
//	
	...
	sys_config_init();	
	//写入配置文件
	sys_config_load_2(1,&ip_settings);  //会返回 printf的数据到web端
	/* Finish up the page */
	//fprintf(cgiOut, "</BODY></HTML>\n");  // no need
	free(str);

	//系统调用
	//system("echo hello >>txt.txt");
	return 0;
}
